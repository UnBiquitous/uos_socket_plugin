...
public class TestActiveDiscreteTCP extends TestCase {
	...
	protected synchronized void setUp() throws Exception {
		...
		applicationContext.start("org/unbiquitous/uos/core/connectivityTest/propertiesTCP");
	...
	public void testTCPConsumesDiscreteUDP() throws Exception {
		...
		try {
			Response response = this.applicationContext.getGateway().callService(
					...
					"listDrivers", "uos.DeviceDriver", "deviceDriverImplIdUDPDevice", null, // No
					// security
					// needed
					parameterMap // Informing the current device data to the remote
									// device
			);
	...
	@SuppressWarnings("unchecked")
	public void testTCPConsumesDiscreteBluetooth() throws Exception {
