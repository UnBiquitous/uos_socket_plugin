...
public class TestBasicMiddlewareAuthenticationHandler extends TestCase {
	...
	public void testSendSuccessfulAuthenticate_Second_Step()
		...
		String notifyMessage = "{\"type:\"SERVICE_CALL_REQUEST\",\"driver\":\"uos.DeviceDriver\",\"service\":\"authenticate\","
				+ "\"parameters\":{\"securityType\":\"BASIC\",\"hashId\":\"" + m1.getHashId() + "\","
				+ "\"idEnc\":\"" + m1.getIdEnc() + "\",\"ra1Enc\":\"" + m1.getRa1Enc() + "\","
				+ "\"ra2Enc':\"" + m1.getRa2Enc() + "\",\"hmacM1\":\"" + m1.getHmacM1() + "\"}}";
		...
		SecondMessage m2 = authentication.runSecondStep(m1.getHashId(), m1.getIdEnc(), m1.getRa1Enc(), m1.getRa2Enc(),
				m1.getHmacM1());

		// checks returned message. If the return is equals the return of m2,
	...
	public void testSendSuccessfulAuthenticate_Fourth_Step()
		...
		SecondMessage m2 = authentication.runSecondStep(m1.getHashId(), m1.getIdEnc(), m1.getRa1Enc(), m1.getRa2Enc(),
				m1.getHmacM1());
		ThirdMessage m3 = authentication.runThirdStep("5f8d93682477592c1479ee7803ac44e1", m1.getRa1(), m1.getRa2(),
				"WrongDummyDevice", m2.getHmac(), m2.getIdEnc(), m2.getRa1IncEnc(), m2.getRa2IncEnc(), m2.getRb1Enc(),
				m2.getRb2Enc());
		...
		String notifyMessage = "{\"type\":\"SERVICE_CALL_REQUEST\",\"driver\":\"uos.DeviceDriver\",\"service\":\"authenticate\","
				+ "\"parameters\":{\"securityType\":\"BASIC\",\"sessionKeyEnc\":\"" + sessionKeyEnc + "\","
				+ "\"hmacM3\":\"" + hmacM3 + "\","
				+ "\"id\":\"" + id + "\","
				+ "\"rb1\":\"" + rb1 + "\"}}";
	...
	public void testSendUnsuccessfulAuthenticate_Second_Step()
		...
		FirstMessage m1 = authentication.runFirstStep("WrongDummyDevice", "5f8d93682477592c1479ee7803ac44e1");
		// SecondMessage m2 = authentication.runSecondStep(m1.getHashId(),
		// m1.getIdEnc(), m1.getRa1Enc(), m1.getRa2Enc(), m1.getHmacM1());

		// send notifyMessage with incorrect ra2Enc
		String notifyMessage = "{\"type:\"SERVICE_CALL_REQUEST\",driver:\"uos.DeviceDriver\",\"service\":\"authenticate\","
				+ "\"parameters\":{\"securityType\":\"BASIC\",\"hashId\":\"" + m1.getHashId() + "\","
				+ "\"idEnc\":\"" + m1.getIdEnc() + "\",\"ra1Enc\":\"" + m1.getRa1Enc() + "\","
				+ "\"ra2Enc\":\"" + "yVJTzuEJI07h9Gj45bWaakbt/LyXLHOuVeE1NIZUnIw=" + "\",\"hmacM1\":\"" + m1.getHmacM1() + "\"}}";
	...
	public void testSendUnsuccessfulAuthenticate_Fourth_Step()
		...
		String notifyMessage = "{\"type\":\"SERVICE_CALL_REQUEST\",\"driver\":\"uos.DeviceDriver\",\"service\":\"authenticate\","
				+ "\"parameters\":{\"securityType\":\"BASIC\",\"sessionKeyEnc\":\"" + sessionKeyEnc + "\","
				+ "\"hmacM3\":\"" + "758F3AB2EB34658ED3A011A51B695E4A" + "\",\"id\":\"" + id + "\","
				+ "\"rb1':\"" + rb1 + "\"}}";
